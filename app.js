// Chapter # 1:
// Q1:
// alert("Good Evening!! Have a nice day");
// Q2:
// alert("Error ! Please enter a valid password");
// Q3:
// alert("Welcome to JS lan..\nHappy Coding!");
// Q4:
...
//Chapter # 2:
// Q1:
// var username="Sajeel Ahmed Siddiqui";
// Q2:
// var Myname="Sajeel Ahmed Siddiqui";
// alert(Myname);
// Q3:
// var message="Hello World";
// alert(message);
// Q4:
// var a="Sajeel Ahmed Siddiqui";
// alert(a);
// var b="22 year old";
// alert(b);
...
// alert(pizza);
// Q6:
// var email="sajeelahmedsiddiqui@gmail.com";
// alert("My email address is "+email);
// Q7:
// var book="A smarter way to learn Java Script";
// alert("I am learning from the book "+book);
// Q8:
// var html="Yah ! Ican write HTML content through JavaScript";
// document.write(html);
// Q9:
// var design="▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬";
// alert(design);
...
// var var3=var2%3;
// document.write("The Remainder after dividing by is:"+var3+".<br/>");

// Q4:
// var x=600;
// var y=x*5;
// document.write("Total Cost to buy 5 movie ticket is "+y+"PKR");

// Q5
// var a = +prompt("Please enter your number to generate table");
...
// var f=((celtemp * (9/5))+32);
// var fartemp=+prompt("Enter Temperature in Fahrenheit");
// var c=((fartemp - 32) * (5/9));
// document.write(celtemp+"C Is"+f+"F"+"<br>");
// document.write(fartemp+"F Is"+c+"C"+"<br>");
...
// document.write("Shipping Charges "+sq+"<br>");
...
// var dollar=10;
// var riyal=25;
// var dollpkr=dollar*104.80;
// var riypkr=riyal*28;
// document.write("Currency in PKR.<br>");
// document.write("10 Dollars in Rupees: "+dollpkr+".<br>");
// document.write("25 Riyal in Rupees: "+riypkr+".<br>")
...
// var curryear=+prompt("Enter Current ");
...
// document.write("The Geometizer<br>");
// document.write("Radius of Cricle is: "+r+".<br>");
// var circum= 2*3.142*r;
// document.write("Circumference of Cricle is: "+circum+".<br>");
// var area=3.14*(r*r);
// document.write("Area of Cricle is: "+area+".<br>");


// Q13
// var favsnack=prompt("What is your favourite snack?");
// var currage=+prompt("What is your current age?");
// var maxage=+prompt("What is your estimated Max age?")
// var snacksperday=+prompt("How many snacks do you consume per day?");

// document.write("Favourite Snack: "+favsnack+"<br>");
// document.write("Current Age: "+currage+"<br>");
// document.write("MAximum Estimated Age: "+maxage+"<br>")
// document.write("Your Age Is: "+snacksperday+"<br>")
// var result=(maxage-currage)*snacksperday
// document.write("You will need "+ result+" chocolate chip to last you until the ripe old age of "+ maxage+"<br>")


// Chapters 6-9
// Q1
// var a = +prompt("Please enter your number", "Enter Number Here");
...
// var re3=re2 + b--;
// document.write("--a - --b + ++b +b-- Hence Final Result Would Be: "+re3+"<br>");
...
//   }
// Q6
// var a = prompt("Please enter Subject 1 Name");
// var b = +prompt("Please enter Subject 1 Marks");

// var c = prompt("Please enter Subject 2 Name");
// var d = +prompt("Please enter Subject 2 Marks");

// var e = prompt("Please enter Subject 3 Name");
// var f = +prompt("Please enter Subject 3 Marks");
// sum=b+d+f
// pecentage=sum/300
// final=pecentage*100
...
// var fuel=prompt("Insert the amount of Fuel in your car(In liters)","Insert fuel here");
// if (fuel<0.25 && fuel>0){
...
// document.write("<br/>");
// var marks=prompt("Enter your marks","Marks here");
...
// var secnum=+prompt("Enter your Number from 1 to 10","Here");
// if (secnum==7){
...
// }
// else{
//     alert("Number isnt divisible by 3");
// }
...
// var color_arr = [];
// var input_color = prompt("Color Name: ");
// color_arr.push(input_color);
// document.write(color_arr);

// var last_color = prompt("Color Name: ");
// color_arr.push(input_color);
// document.write(color_arr);
...
// document.write("Original Array: "+clr+'<br>');
...
// document.write(arrayyy);
// document.write("<hr>");
// document.write("Out: <br>"+arrayyy[0]+"<br>");
// document.write("Out: <br>"+arrayyy[1]+"<br>");
// document.write("Out: <br>"+arrayyy[2]+"<br>");
// document.write("Out: <br>"+arrayyy[3]+"<br>");
